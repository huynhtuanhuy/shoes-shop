...
class EditProducts extends Component {
    ...
    handleSubmit = (e) => {
        e.preventDefault();
        const { id, name, sku, description, is_new, is_disable, categories, product_details } = this.state.formData;
        
        this.props.updateProduct({ id, name, sku, description, is_new, is_disable, categories, product_details }, () => {
                                    ...
                                    <div>
                                        {product_details.map((product_detail, index) => (
                                            <CCard key={index}>
                                                ...
                                                {
                                                    !product_detail.id && <CCardFooter className="text-right">
